                    ...
                    <table className="table w-full p-6 notes-upload-sec">
                      <tbody className='notes-upload-box'>
                        <tr className="sec-one">
                          <td className="sec-one-inner"><TextField className='w-full' variant="outlined" type="text" name="name" id="outlined-basic" label="Notes Name" value={notesname.name} onChange={handleInputs} /></td>
                          <td className="sec-one-inner"><TextField className='w-full' variant="outlined" type="text" name="subject" id="outlined-basic" label="Subject" value={notesname.subject} onChange={handleInputs} /></td>
                          <td className="sec-one-inner"><TextField className='w-full' variant="outlined" type="text" name="year" id="outlined-basic" label="Year" value={notesname.year} onChange={handleInputs} /></td>
                        </tr>
                        <tr className="sec-two">
                          <td colSpan="2"><TextField className='w-full' variant="outlined" type="text" name="link" id="outlined-basic" label="Link" value={notesname.link} onChange={handleInputs} /></td>
                          <td><input className='w-full bg-blue-500 hover:text-white rounded-md text-white' id='notes-form-button' type="submit" value="Submit" onClick={PostData}></input></td>
                        </tr>
                      </tbody>
                    </table>
